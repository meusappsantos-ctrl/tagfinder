...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-900 items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-blue-600/20 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-indigo-600/20 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="w-full max-w-sm sm:max-w-md bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden relative z-10">
        ...
        <div className="p-6 sm:p-8">
          <form onSubmit={handleAuth} className="space-y-5 sm:space-y-6">
            ...
            {/* Error Alert */}
            {error && (
              <div className="bg-red-900/20 border-l-4 border-red-500 p-3 sm:p-4 rounded-md flex items-start gap-3">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <label className="text-xs sm:text-sm font-medium text-slate-300 block" htmlFor="email">
                Email
              </label>
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-9 sm:pl-10 pr-3 py-2 sm:py-2.5 bg-slate-700 border border-slate-600 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none placeholder-slate-400 text-sm"
            ...
            <div className="space-y-1.5 sm:space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-9 sm:pl-10 pr-9 sm:pr-10 py-2 sm:py-2.5 bg-slate-700 border border-slate-600 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none placeholder-slate-400 text-sm"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 sm:py-3 px-4 rounded-lg shadow-lg hover:shadow-blue-600/30 transition-all transform active:scale-95 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none text-sm sm:text-base"
            >
              {loading ? (
